/*	
	...
	It is written on the premise that it is calculated with the Ito Supercomputer of Kyushu University of Japan.
	Also, the compiler is based on using Intel.
*/

#include <iostream>
#include <vector>
#include "../header/random.h"
#include "../header/Fstream.h"
